...
bool OBJModel::load(const std::string& path) {
    ...
    glVertexAttribPointer(POSITION_ATTR, 3, GL_FLOAT, GL_FALSE, sizeof(ShapeVertex), (const void*)0);
    glVertexAttribPointer(NORMAL_ATTR, 3, GL_FLOAT, GL_FALSE, sizeof(ShapeVertex), (const void*)offsetof(ShapeVertex, normal));
    glVertexAttribPointer(TEXCOORD_ATTR, 2, GL_FLOAT, GL_FALSE, sizeof(ShapeVertex), (const void*)offsetof(ShapeVertex, texCoords));
